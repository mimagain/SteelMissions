...
package io.github.stev6.steelmissions.config;

import io.github.stev6.steelmissions.SteelMissions;
import io.github.stev6.steelmissions.config.records.DefaultMission;
...
import io.github.stev6.steelmissions.exceptions.ConfigException;
...
public class ConfigManager {
    ...
    public ConfigManager(SteelMissions plugin) {
        this.plugin = plugin;
    ...
    private void handleException(String when, ConfigException e) {
        ...
        logger.severe("=======================================");
        logger.severe("         SteelMissions CONFIG ERROR      ");
